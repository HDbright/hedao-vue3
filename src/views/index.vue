  ...
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>合道后台管理框架</h2>
        <p>
          合道管理系统，可以用于所有的Web应用程序，如网站管理后台，网站会员中心，CMS，CRM，OA等等，当然，您也可以对她进行深度定制，以做出更强系统。所有前端后台代码封装过后十分精简易上手，出错概率低。同时支持移动客户端访问。系统会陆续更新一些实用功能。
        </p>
        <p>
        ...
        <p>
          <el-button
            ...
            icon="Cloudy"
            plain
            @click="goTarget('https://gitee.com/hdbright/hedao-vue')"
            >访问码云</el-button
          >
          <el-button
            icon="HomeFilled"
            plain
            @click="goTarget('http://hedao.vip')"
            >访问主页</el-button
          >
        </p>
      </el-col>
          ...
          <div class="body">
            <p>
              <i class="el-icon-s-promotion"></i> 官网：<el-link
                href="http://www.hedao.vip"
                target="_blank"
                >http://www.hedao.vip</el-link
              >
            </p>
